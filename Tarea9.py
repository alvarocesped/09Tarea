...
def minimizar1(datos_d, H0):
    '''
    Esta función y la siguiente son solo la simulación bootstrap
    '''
...
H0_inicial = 5
distancia = np.loadtxt("data/hubble_original.dat", usecols=[-2])
velocidad = np.loadtxt("data/hubble_original.dat", usecols=[-1])
